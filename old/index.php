...
<header>
    <div class="header-container">
        ...
        <div class="titulo">
            <strong>CENTRO DE DOUTRINA DO EXÉRCITO</strong>
            PAINEL DE MANUAIS
        </div>
        ...
        <div class="manual">
            ...
            <div class="icons">
                <?php if (!empty($row['video'])): ?>
                    <a href="uploads/videos/<?= htmlspecialchars($row['video']) ?>" target="_blank" title="Ver vídeo 📹" style="font-size: 35px;">📹</a>
                <?php endif; ?>
                <?php if (!empty($row['epub'])): ?>
                    <a href="uploads/epub/<?= htmlspecialchars($row['epub']) ?>" download title="Baixar EPUB 📘" style="font-size: 35px;">📘</a>
                <?php endif; ?>
            </div>
        </div>
    <?php endwhile; ?>
